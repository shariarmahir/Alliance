...
export const ADMIN_NAV_ITEMS: AdminNavItem[] = [
  ...
  { label: "Stock", href: "/admin/stock", icon: "stock", roles: ["super", "sub"], enabled: false },
  { label: "Hero Images", href: "/admin/hero-images", icon: "hero-images", roles: ["super", "sub"], enabled: false },
